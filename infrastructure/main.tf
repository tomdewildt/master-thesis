...
resource "azurerm_network_watcher" "nw" {
  name                = "${var.namespace}-${var.name}-nw-${var.environment}-${var.location}-01"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name
}

resource "azurerm_virtual_network" "vnet" {
  name                = "${var.namespace}-${var.name}-vnet-${var.environment}-${var.location}-01"
...
resource "azurerm_subnet" "snet" {
  name                 = "${var.namespace}-${var.name}-snet-${var.environment}-${var.location}-01"
  resource_group_name  = azurerm_resource_group.rg.name
...
resource "azurerm_public_ip" "pip" {
  name                = "${var.namespace}-${var.name}-pip-${var.environment}-${var.location}-01"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name
...
resource "azurerm_network_security_group" "nsg" {
  name                = "${var.namespace}-${var.name}-nsg-${var.environment}-${var.location}-01"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name
...
resource "azurerm_network_interface" "nic" {
  name                = "${var.namespace}-${var.name}-nic-${var.environment}-${var.location}-01"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name

  ip_configuration {
    name                          = "${var.namespace}-${var.name}-nc-${var.environment}-${var.location}-01"
...
resource "azurerm_linux_virtual_machine" "vm" {
  name                  = "${var.namespace}-${var.name}-vm-${var.environment}-${var.location}-01"
  location              = azurerm_resource_group.rg.location
  resource_group_name   = azurerm_resource_group.rg.name
  ...
  os_disk {
    name                 = "${var.namespace}-${var.name}-osdisk-${var.environment}-${var.location}-01"
    caching              = "ReadWrite"
